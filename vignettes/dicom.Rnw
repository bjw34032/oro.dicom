...
jpeg(filename="dicom_abdo.jpeg", width=480, height=480, quality=50, bg="black")
par(mar=rep(0,4))
@ 
<<abdo-image>>=
...
jpeg(filename="dcmImage.jpeg", width=1.5*480, height=1.5*480, quality=50, bg="black")
image(t(dcm$img), col=grey(0:64/64), zlim=c(16, 1024), axes=FALSE, 
      xlab="", ylab="")
dev.off()
jpeg(filename="dcmNifti.jpeg", width=480, height=480, quality=50, bg="black")
...
jpeg("hk40n_image.jpeg", width=480, height=480, quality=50, bg="black")
image(hk40n, zlim=c(0,1024))
dev.off()
jpeg("hk40n_orthographic.jpeg", width=480, height=480, quality=50, bg="black")
